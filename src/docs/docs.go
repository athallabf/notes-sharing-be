...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/example.GetNotesResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/example.CreateNoteResponse"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/example.GetNoteResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/example.InvalidNoteIDError"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "patch": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/example.UpdateNoteResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/example.UploadFileResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "example.CreateNoteResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "$ref": "#/definitions/example.Note"
                },
                "message": {
                    "type": "string",
        ...
        "example.Note": {
            ...
            "properties": {
                ...
                "file_path": {
                    "type": "string",
                    "example": "abcdef-12345.pdf"
                },
                "file_url": {
                    "type": "string",
                    "example": "https://s3.tebi.io/your-bucket/abcdef-12345.pdf?..."
                },
                "id": {
                    "type": "string",
        ...
        "example.UploadFileResponse": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "File uploaded and attached to note successfully"
                },
                "status": {
                    "type": "string",
                    "example": "success"
